...
<html>
  ...
  @section('pages','Fortis Wheels')
  @section('content-helper')
    <div class="col-sm-2 ml-auto">
      <a href="{{ url('wheel/fortis/create') }}">
                ...
                @foreach ($data as $item)
                  <tr>
                    ...
                    <td>
                      <div class="row">
                        <div class="col-md-4">
                          <a href="{{ url('/wheel/fortis/view/'.$item->uuid) }}" style="margin-right: 0.5rem">
                            <button type="button" class="btn btn-block btn-outline-secondary btn-xs"><i class="fas ion-eye"></i>View</button>
                          </a>
                        </div>
                        <div class="col-md-4">
                          <a href="{{ url('/wheel/fortis/'.$item->uuid) }}" style="margin-right: 0.5rem">
                        ...
                        <div class="col-md-4">
                          <a href="#" data-toggle="modal" data-target="#modal-confirmation-delete">
                            <button type="button" class="btn btn-block btn-outline-secondary btn-xs" onclick="deleteItem('{{ url('/wheel/fortis/delete/'.$item->uuid) }}')"><i class="fas fa-trash"></i>Delete</button>
                          </a>
                        </div>
                      </div>
                    </td>
