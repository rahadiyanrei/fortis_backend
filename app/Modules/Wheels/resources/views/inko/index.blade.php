                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      <a href="{{ url('/wheel/inko/'.$item->uuid) }}" style="margin-right: 0.5rem">
                                    ...
                                    <div class="col-md-4">
                                      <a href="#" data-toggle="modal" data-target="#modal-confirmation-delete">
                                        <button type="button" class="btn btn-block btn-outline-secondary btn-xs" onclick="deleteItem('{{ url('/wheel/inko/delete/'.$item->uuid) }}')"><i class="fas fa-trash"></i>Delete</button>
                                      </a>
                                    </div>
                                  </div>
                                </td>
